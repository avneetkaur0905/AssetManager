...
// Load the MySQL JDBC driver
        ...
        String sql = "INSERT INTO assetlist (assetName, assetType, category, assetPrice, dateofpurchase, details) VALUES (?, ?, ?, ?, ?, ?)";
...
%>
            ...
            <button onclick="window.location.href='../fe/addasset.html'">Home</button>
<%
        } else {
